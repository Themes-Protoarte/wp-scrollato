...
$opt_list = array(
	...
	'header-background-image' => get_template_directory_uri() . '/imgs/Red_geranium_by_qerubin.jpg',
	'header-text-maxwidth' => '700px',
	'header-text-color' => '#ffffff',
	'header-extra-content' => '',
	'header-skrollr-start' => 'opacity: 1; background-position: 0px 0px;',
	'header-skrollr-end' => 'opacity: 0.5; background-position: 0px -30px;',
